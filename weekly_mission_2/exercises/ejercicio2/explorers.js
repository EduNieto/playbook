...
const result = explorers.reduce((acc, exercises) => acc + exercises.exercises_completed, 0);
...
console.log("Algún explorer ha finalizado la misión frontend? ", exerciseFinished);

// Obtén la validación si todos los explorers tienen la propiedad isFinished del onboarding como true. Usa EVERY.
const onBoarding = explorers.every((explorer) => explorer.missions.onboarding.isFinished === true);
